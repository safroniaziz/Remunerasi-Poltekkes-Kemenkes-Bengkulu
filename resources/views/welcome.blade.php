        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="col-span-1 ">
                <div class=" px-6 mb-6 py-6 bg-white rounded-lg shadow-md">
                    ...
                    <form method="GET" id="pencarianPengumuman">
                        <div class="relative">
                            <input type="text" name="judulPencarian" value="{{$judulPencarian}}" class="w-full py-3  pr-4 mb-4 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 text-[14px]" placeholder="Cari Judul Pengumuman">
                        </div>
                        <button type="submit" class="  py-2   my-3 w-full text-white text-[14px] transition-colors duration-300 transform   lg:mt-0     bg-gradient-to-r  from-[#0d276e] to-[#18a6ede3] border border-white rounded-lg  hover:from-[#09072ce3] hover:to-[#18a6ede7]  px-5  ">Cari</button>
                    </form>
                </div>
            </div>
