...
<body class="  antialiased leading-normal tracking-wide 2xl:text-xl font-nunito  bg-red   text-slate-900"
            ...
            <div class="lg:flex lg:items-center lg:justify-between  ">
                ...
                <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-[#152042]   md:bg-none menu-navbar text-white lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto
                    ...
                    <div class="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8 ">
                        <a href="{{ route('home') }}" class="px-3 py-2 mx-2 mt-2 text-gray-100 transition-colors duration-300 transform rounded-md
    ...
    <!-- content detail -->
    <section   >
        <div class="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto mt-36 mb-32">
            ...
            <article class="space-y-10   text-gray-900">
                <div class="space-y-8 ">
                 <div class=" ">
                    <h2 class="text-4xl font-bold   md:text-2xl text-center">
                    ...
                    <div
                        ...
                        <div class="flex items-center md:space-x-2">
                            <p class="text-sm "><strong>{{ $pengumuman->tanggal_pengumuman->isoFormat('dddd, DDDD MMMM YYYY') }}</strong></p>
                        </div>
                    </div>
                </div>
                <div class="text-gray-800 text-[16px] leading-7">
                    <p class="    font-medium text-[14px] text-gray-900 mb-8  text-justify">
                    ...
                    @if ($pengumuman->file_pengumuman != null || $pengumuman->file_pengumuman != "")
                        ...
                        <a href="{{ route('home.download_pengumuman',[$pengumuman->id]) }}"
