...
<div class="modal fade" id="modalubahpassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form action=" {{ route('manajemen_data_administrator.ubahPassword') }} " method="POST" enctype="multipart/form-data" id="form-ubah-password">
            {{ csrf_field() }} {{ method_field('PATCH') }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm btn-flat" id="btn-submit2"><i class="fa fa-check-circle"></i>&nbsp;Simpan Perubahan Password</button>
                </div>
            </div>
        </form>
    </div>
