                                ...
                                <tbody>
                                    ...
                                    @foreach ($r02perkuliahanpraktikums as $index => $r02perkuliahanpraktikum)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $r02perkuliahanpraktikum->prodiMatkul->nama_prodi }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">{{ $r02perkuliahanpraktikum->point ? $r02perkuliahanpraktikum->point : '-' }}</td>
                                            @endif
                                            <td>
                                                <table>
                                                    <tr>
