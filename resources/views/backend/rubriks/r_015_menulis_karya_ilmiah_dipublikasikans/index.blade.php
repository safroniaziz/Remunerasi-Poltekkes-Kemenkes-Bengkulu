                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 15 Menulis Karya Ilmiah Dipublikasikan
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                    ...
                                    @foreach ($r015menuliskaryailmiahdipublikasikans as $index => $r015menuliskaryailmiahdipublikasikan)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    <form action="{{ route('r_015_menulis_karya_ilmiah_dipublikasikan.verifikasi',[$r015menuliskaryailmiahdipublikasikan->id]) }}" method="POST">
                                                        {{ csrf_field() }} {{ method_field('PATCH') }}
