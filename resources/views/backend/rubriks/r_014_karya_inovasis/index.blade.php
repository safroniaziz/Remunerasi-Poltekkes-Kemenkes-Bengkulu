                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 14 Karya Inovasi
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r014karyainovasis as $index => $r014karyainovasi)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if ($r014karyainovasi->is_verified == 1)
                                                    <form action="{{ route('r_014_karya_inovasi.tolak',[$r014karyainovasi->id]) }}" method="POST">
                                                        {{ csrf_field() }} {{ method_field('PATCH') }}
                                                        <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                    </form>
                                                @else
                                                    <form action="{{ route('r_014_karya_inovasi.verifikasi',[$r014karyainovasi->id]) }}" method="POST">
                                                        {{ csrf_field() }} {{ method_field('PATCH') }}
...
@push('scripts')
    ...
    <script>
        ...
        function editr014karyainovasi(id){
            ...
            url = "{{ url('r_014_karya_inovasi').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
