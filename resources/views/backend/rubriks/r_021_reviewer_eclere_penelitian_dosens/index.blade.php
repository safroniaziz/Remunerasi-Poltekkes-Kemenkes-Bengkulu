                                ...
                                <tbody>
                                    ...
                                    @foreach ($r021reviewereclerepenelitiandosens as $index => $r021reviewereclerepenelitiandosen)
                                        <tr>
                                            ...
                                            <td>{{ $r021reviewereclerepenelitiandosen->keterangan }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    @if ($r021reviewereclerepenelitiandosen->is_verified == 1)
                                                        <form action="{{ route('r_021_reviewer_eclere_penelitian_dosen.tolak',[$r021reviewereclerepenelitiandosen->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_021_reviewer_eclere_penelitian_dosen.verifikasi',[$r021reviewereclerepenelitiandosen->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
