                                    ...
                                    @foreach ($r04membimbingpendampinganukoms as $index => $r04membimbingpendampinganukom)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    @if ($r04membimbingpendampinganukom->is_verified == 1)
                                                        <form action="{{ route('r_04_membimbing_pendampingan_ukom.tolak',[$r04membimbingpendampinganukom->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_04_membimbing_pendampingan_ukom.verifikasi',[$r04membimbingpendampinganukom->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
