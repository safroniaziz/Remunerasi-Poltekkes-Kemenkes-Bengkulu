        ...
        <div class="modal-content">
            <form action="{{ route('r_04_membimbing_pendampingan_ukom.store') }}" method="POST" id="form-tambah-r-04">
                ...
                <div class="modal-header">
                    ...
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah R 03 Membimbing Tutorial Pencapaian Kompetensi</p>
                </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-04',function (event){
