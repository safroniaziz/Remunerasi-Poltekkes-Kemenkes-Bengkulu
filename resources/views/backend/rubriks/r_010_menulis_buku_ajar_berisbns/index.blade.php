                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 10
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                    ...
                                    @foreach ($r010menulisbukuajarberisbns as $index => $r010menulisbukuajarberisbn)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    @if ($r010menulisbukuajarberisbn->is_verified == 1)
                                                        <form action="{{ route('r_010_menulis_buku_ajar_berisbn.tolak',[$r010menulisbukuajarberisbn->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_010_menulis_buku_ajar_berisbn.verifikasi',[$r010menulisbukuajarberisbn->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
