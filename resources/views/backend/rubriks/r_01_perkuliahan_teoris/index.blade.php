                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 01 Perkuliahan Teori
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                    ...
                                    @foreach ($r01perkuliahanteoris as $index => $r01perkuliahanteori)
                                        <tr>
                                            ...
                                            @if(Auth::user()->hasRole('verifikator'))
                                                ...
                                                <td class="text-center">
                                                    @if ($r01perkuliahanteori->is_verified == 1)
                                                        <form action="{{ route('r_01_perkuliahan_teori.tolak',[$r01perkuliahanteori->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_01_perkuliahan_teori.verifikasi',[$r01perkuliahanteori->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
