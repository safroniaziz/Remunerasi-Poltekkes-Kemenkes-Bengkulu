@extends('layouts.app')
@section('subTitle','Data R 03 Membimbing Tutorial Pencapaian Kompetensi')
@section('page','Data R 03 Membimbing Tutorial Pencapaian Kompetensi')
        ...
        <div class="col-md-12">
            <section class="panel" style="margin-bottom:20px;">
                <header class="bg-primary" style="color: #ffffff;background-color: #3c8dbc;border-color: #fff000;border-image: none;border-style: solid solid none;border-width: 4px 0px 0;border-radius: 0;font-size: 14px;font-weight: 700;padding: 15px;">
                    <i class="fa fa-users"></i>&nbsp; Manajemen Data R 03 Membimbing Tutorial Pencapaian Kompetensi
                </header>
                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah R 03 Membimbing Tutorial Pencapaian Kompetensi
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <table class="table table-striped table-bordered" id="table" style="width:100%; m">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r03membimbingpencapaiankompetensis as $index => $r03membimbingpencapaiankompetensi)
                                        <tr>
                                            <td>{{ $index+1 }}</td>
                                            <td>{{ $r03membimbingpencapaiankompetensi->periode_id }}</td>
