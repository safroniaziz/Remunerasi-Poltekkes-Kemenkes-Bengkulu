                                    ...
                                    @foreach ($r03membimbingpencapaiankompetensis as $index => $r03membimbingpencapaiankompetensi)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <td class="text-center">
                                                    @if ($r03membimbingpencapaiankompetensi->is_verified == 1)
                                                        <form action="{{ route('r_03_membimbing_pencapaian_kompetensi.tolak',[$r03membimbingpencapaiankompetensi->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_03_membimbing_pencapaian_kompetensi.verifikasi',[$r03membimbingpencapaiankompetensi->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
