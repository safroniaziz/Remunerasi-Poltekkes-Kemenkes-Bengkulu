<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_018_mendapat_hibah_pkm.store') }}" method="POST" id="form-tambah-r-018">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 18 Mendapat Hibah PKM</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="judul_hibah_pkm" name="judul_hibah_pkm">
                        </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-018',function (event){
