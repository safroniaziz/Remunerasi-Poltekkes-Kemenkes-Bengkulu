                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_018_mendapat_hibah_pkm.delete',[$r018mendapathibahpkm->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr018mendapathibahpkm(id){
            ...
            url = "{{ url('dosen/r_018_mendapat_hibah_pkm').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
