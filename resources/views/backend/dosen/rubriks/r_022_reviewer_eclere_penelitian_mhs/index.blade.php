            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 22
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r022reviewereclerepenelitianmhs as $index => $r022reviewereclerepenelitianmhs)
                                        <tr>
                                            ...
                                            <td>{{ $r022reviewereclerepenelitianmhs->keterangan }}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_022_reviewer_eclere_penelitian_mhs.delete',[$r022reviewereclerepenelitianmhs->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_022_reviewer_eclere_penelitian_mhs.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_022_reviewer_eclere_penelitian_mhs.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr22revieweclerepenelitimhs(id){
            ...
            url = "{{ url('dosen/r_022_reviewer_eclere_penelitian_mhs').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
