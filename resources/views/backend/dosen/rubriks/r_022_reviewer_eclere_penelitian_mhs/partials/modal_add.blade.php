<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_022_reviewer_eclere_penelitian_mhs.store') }}" method="POST" id="form-tambah-r-22">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 22 Reviewer Eclere Penelitian Mahasiswa</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="judul_protokol_penelitian" name="judul_protokol_penelitian">
                        </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-22',function (event){
