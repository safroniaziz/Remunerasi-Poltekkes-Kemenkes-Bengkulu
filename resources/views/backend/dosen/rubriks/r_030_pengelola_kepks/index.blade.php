                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 30
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_030_pengelola_kepk.delete',[$r030pengelolakepk->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr030pengelolakepk(id){
            ...
            url = "{{ url('dosen/r_030_pengelola_kepk').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
