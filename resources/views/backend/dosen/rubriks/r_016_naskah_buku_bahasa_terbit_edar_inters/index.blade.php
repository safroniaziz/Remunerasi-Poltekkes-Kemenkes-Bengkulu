                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_016_naskah_buku_bahasa_terbit_edar_inter.delete',[$r016naskahbukubahasaterbitedarinter->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr016naskahbukuterbitedarinter(id){
            ...
            url = "{{ url('dosen/r_016_naskah_buku_bahasa_terbit_edar_inter').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
