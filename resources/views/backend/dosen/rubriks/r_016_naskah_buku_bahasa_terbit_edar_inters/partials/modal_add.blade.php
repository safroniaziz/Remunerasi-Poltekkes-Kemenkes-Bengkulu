<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_016_naskah_buku_bahasa_terbit_edar_inter.store') }}" method="POST" id="form-tambah-r-016">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 16 Naskah Buku Bahasa Terbit Edar Internasional</p>
                </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-016',function (event){
