            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_010_menulis_buku_ajar_berisbn.delete',[$r010menulisbukuajarberisbn->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_010_menulis_buku_ajar_berisbns.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_010_menulis_buku_ajar_berisbns.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr010menulisbukuajarberisbn(id){
            ...
            url = "{{ url('dosen/r_010_menulis_buku_ajar_berisbn').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
