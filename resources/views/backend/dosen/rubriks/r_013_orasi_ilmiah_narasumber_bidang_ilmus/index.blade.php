                                ...
                                <tbody>
                                    ...
                                    @foreach ($r013orasiilmiahnarasumberbidangilmus as $index => $r013orasiilmiahnarasumberbidangilmu)
                                        <tr>
                                            ...
                                            <td>{{ $r013orasiilmiahnarasumberbidangilmu->keterangan }}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_013_orasi_ilmiah_narasumber_bidang_ilmu.delete',[$r013orasiilmiahnarasumberbidangilmu->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr013orasiilmiahnarasumber(id){
            ...
            url = "{{ url('dosen/r_013_orasi_ilmiah_narasumber_bidang_ilmu').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
