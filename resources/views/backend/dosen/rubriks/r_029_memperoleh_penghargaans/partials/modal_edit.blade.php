<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_029_memperoleh_penghargaan.update') }}" method="POST" id="form-edit-R29">
                {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Edit Rubrik 29 Memperoleh Penghargaan</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="r29memperolehpenghargaan_id_edit" id="r29memperolehpenghargaan_id_edit">
                        ...
                        <div class="form-group col-md-12" >
                            ...
                            <select name="judul_penghargaan" class="form-control" id="judul_penghargaan_edit">
...
@push('scripts')
    <script>
        $(document).on('submit','#form-edit-R29',function (event){
