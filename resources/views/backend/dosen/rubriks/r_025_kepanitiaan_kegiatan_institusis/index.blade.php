                                ...
                                <tbody>
                                    ...
                                    @foreach ($r025kepanitiaankegiataninstitusis as $index => $r025kepanitiaankegiataninstitusi)
                                        <tr>
                                            ...
                                            <td>{{ $r025kepanitiaankegiataninstitusi->keterangan }}</td>
                                            <td class="text-center">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_025_kepanitiaan_kegiatan_institusi.delete',[$r025kepanitiaankegiataninstitusi->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr025panitiakegiataninstitusi(id){
            ...
            url = "{{ url('dosen/r_025_kepanitiaan_kegiatan_institusi').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
