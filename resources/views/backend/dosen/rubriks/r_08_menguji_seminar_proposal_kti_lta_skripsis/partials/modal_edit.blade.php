<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_08_menguji_seminar_proposal_kti_lta_skripsi.update') }}" method="POST" id="form-edit-R08">
                {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Edit Rubrik 08 Menguji Seminar Proposal KTI LTA Skripsi</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="r08mengujiseminarproposal_id_edit" id="r08mengujiseminarproposal_id_edit">
...
@push('scripts')
    <script>
        $(document).on('submit','#form-edit-R08',function (event){
