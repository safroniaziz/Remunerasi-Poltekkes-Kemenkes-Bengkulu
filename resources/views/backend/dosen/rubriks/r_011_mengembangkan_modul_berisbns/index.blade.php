            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r011mengembangkanmodulberisbns as $index => $r011mengembangkanmodulberisbn)
                                        <tr>
                                            ...
                                            <td>{{ $r011mengembangkanmodulberisbn->keterangan }}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_011_mengembangkan_modul_berisbn.delete',[$r011mengembangkanmodulberisbn->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_011_mengembangkan_modul_berisbns.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_011_mengembangkan_modul_berisbns.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr011mengembangkanmodulberisbn(id){
            ...
            url = "{{ url('dosen/r_011_mengembangkan_modul_berisbn').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
