            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 06
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r06mengujiujianoscas as $index => $r06mengujiujianosca)
                                        <tr>
                                            ...
                                            <td>{{ $r06mengujiujianosca->keterangan }}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_06_menguji_ujian_osca.delete',[$r06mengujiujianosca->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_06_menguji_ujian_oscas.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_06_menguji_ujian_oscas.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr06mengujiujianosca(id){
            ...
            url = "{{ url('dosen/r_06_menguji_ujian_osca').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
