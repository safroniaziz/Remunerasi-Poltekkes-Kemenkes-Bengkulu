@extends('layouts.app')
@section('subTitle','Data Rubrik 04 Membimbing Pendampingan Ukom')
@section('page','Data Rubrik 04 Membimbing Pendampingan Ukom')
        ...
        <div class="col-md-12">
            <section class="panel" style="margin-bottom:20px;">
                <header class="bg-primary" style="color: #ffffff;background-color: #3c8dbc;border-color: #fff000;border-image: none;border-style: solid solid none;border-width: 4px 0px 0;border-radius: 0;font-size: 14px;font-weight: 700;padding: 15px;">
                    <i class="fa fa-users"></i>&nbsp; Manajemen Data Rubrik 04 Membimbing Pendampingan Ukom
                </header>
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r04membimbingpendampinganukoms as $index => $r04membimbingpendampinganukom)
                                        <tr>
                                            ...
                                            <td>{{ $r04membimbingpendampinganukom->keterangan }}</td>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_04_membimbing_pendampingan_ukom.delete',[$r04membimbingpendampinganukom->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_04_membimbing_pendampingan_ukoms.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_04_membimbing_pendampingan_ukoms.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editR04membimbingpendampinganukom(id){
            ...
            url = "{{ url('dosen/r_04_membimbing_pendampingan_ukom').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
