            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_07_membimbing_skripsi_lta_la_profesi.delete',[$r07membimbingskripsiltalaprofesi->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_07_membimbing_skripsi_lta_la_profesis.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_07_membimbing_skripsi_lta_la_profesis.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr07membimbingskripsiltalaprofesi(id){
            ...
            url = "{{ url('dosen/r_07_membimbing_skripsi_lta_la_profesi').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
