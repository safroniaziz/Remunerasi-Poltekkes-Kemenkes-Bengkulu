                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_028_melaksanakan_pengembangan_diri.delete',[$r028melaksanakanpengembangandiri->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr028laksanakanpengembangandiri(id){
            ...
            url = "{{ url('dosen/r_028_melaksanakan_pengembangan_diri').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
