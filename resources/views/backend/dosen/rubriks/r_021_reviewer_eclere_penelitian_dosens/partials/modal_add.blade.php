<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_021_reviewer_eclere_penelitian_dosen.store') }}" method="POST" id="form-tambah-r-21">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 21 Reviewer Eclere Penelitian Dosen</p>
                </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-21',function (event){
