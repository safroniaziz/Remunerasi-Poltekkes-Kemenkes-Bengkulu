<div class="modal fade" id="modalEdit">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_021_reviewer_eclere_penelitian_dosen.update') }}" method="POST" id="form-edit-R21">
                {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Edit Rubrik 21 Reviewer Eclere Penelitian Dosen</p>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <input type="hidden" name="r21revieweclerepenelitidosen_id_edit" id="r21revieweclerepenelitidosen_id_edit">
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Judul Protokol Penelitian</label>
                            <input type="text" class="form-control" id="judul_protokol_penelitian_edit" name="judul_protokol_penelitian">
                        </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-edit-R21',function (event){
