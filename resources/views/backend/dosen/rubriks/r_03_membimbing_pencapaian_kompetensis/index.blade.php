            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 03
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_03_membimbing_pencapaian_kompetensi.delete',[$r03membimbingpencapaiankompetensi->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_03_membimbing_pencapaian_kompetensis.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_03_membimbing_pencapaian_kompetensis.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
