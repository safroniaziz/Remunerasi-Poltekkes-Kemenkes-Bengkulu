            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_023_auditor_mutu_assessor_akred_internal.delete',[$r023auditormutuassessorakredinternal->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_023_auditor_mutu_assessor_akred_internals.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_023_auditor_mutu_assessor_akred_internals.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr23auditmutuasesorakredinternal(id){
            ...
            url = "{{ url('dosen/r_023_auditor_mutu_assessor_akred_internal').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
