<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_05_membimbing_praktik_pkk_pbl_klinik.store') }}" method="POST" id="form-tambah-r-05">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 05 Membimbing Praktik PKK PBL Klinik</p>
                </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-05',function (event){
