<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('dosen.r_024_tim_akred_prodi_dan_direktorat.store') }}" method="POST" id="form-tambah-r-24">
                {{ csrf_field() }} {{ method_field('POST') }}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <p style="font-weight: bold"><i class="fa fa-plus"></i>&nbsp;Form Tambah Rubrik 24 Tim Akreditasi Prodi dan Direktorat</p>
                </div>
...
@push('scripts')
    <script>
        $(document).on('submit','#form-tambah-r-24',function (event){
