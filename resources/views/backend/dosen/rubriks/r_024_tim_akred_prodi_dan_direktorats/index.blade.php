                        ...
                        <div class="col-md-12">
                            <div style="margin-bottom: 10px !important;">
                                <button type="button" class="btn btn-primary btn-sm btn-flat" data-toggle="modal" data-target="#modal-default">
                                    <i class="fa fa-plus"></i>&nbsp; Tambah Rubrik 24
                                </button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                    ...
                                    @foreach ($r024timakredprodirektorats as $index => $r024timakredprodirektorat)
                                        <tr>
                                            ...
                                            @if(Auth::user()->hasRole('verifikator'))
                                                ...
                                                <td class="text-center">
                                                    @if ($r024timakredprodirektorat->is_verified == 1)
                                                        <form action="{{ route('r_024_tim_akred_prodi_dan_direktorat.tolak',[$r024timakredprodirektorat->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
                                                            <button type="submit" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-thumbs-up"></i></button>
                                                        </form>
                                                    @else
                                                        <form action="{{ route('r_024_tim_akred_prodi_dan_direktorat.verifikasi',[$r024timakredprodirektorat->id]) }}" method="POST">
                                                            {{ csrf_field() }} {{ method_field('PATCH') }}
