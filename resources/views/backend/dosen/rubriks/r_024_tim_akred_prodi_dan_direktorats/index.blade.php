                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_024_tim_akred_prodi_dan_direktorat.delete',[$r024timakredprodirektorat->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr24timakredprodirektorat(id){
            ...
            url = "{{ url('dosen/r_024_tim_akred_prodi_dan_direktorat').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
