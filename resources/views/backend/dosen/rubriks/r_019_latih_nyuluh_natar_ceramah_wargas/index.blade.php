                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_019_latih_nyuluh_natar_ceramah_warga.delete',[$r019latihnyuluhnatarceramahwarga->id]) }}" method="POST" id="form-hapus">
...
@push('scripts')
    ...
    <script>
        ...
        function editr019latihnyuluhnatarceramahwarga(id){
            ...
            url = "{{ url('dosen/r_019_latih_nyuluh_natar_ceramah_warga').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
