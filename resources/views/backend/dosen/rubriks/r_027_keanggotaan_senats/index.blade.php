            ...
            <section class="panel" style="margin-bottom:20px;">
                ...
                <div class="panel-body" style="border-top: 1px solid #eee; padding:15px; background:white;">
                    <div class="row" style="margin-right:-15px; margin-left:-15px;">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($r027keanggotaansenats as $index => $r027keanggotaansenat)
                                        <tr>
                                            ...
                                            <td>{{ $r027keanggotaansenat->keterangan }}</td>
                                            <td class="text-center">
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('dosen.r_027_keanggotaan_senat.delete',[$r027keanggotaansenat->id]) }}" method="POST" id="form-hapus">
                        ...
                        @include('backend/dosen/rubriks/r_027_keanggotaan_senats.partials.modal_add')
                    </div>
                    @include('backend/dosen/rubriks/r_027_keanggotaan_senats.partials.modal_edit')
                </div>
            </section>
        </div>
    </div>
...
@push('scripts')
    ...
    <script>
        ...
        function editr027keanggotaansenat(id){
            ...
            url = "{{ url('dosen/r_027_keanggotaan_senat').'/' }}"+id+'/edit';
            $.ajax({
                url : url,
                type : 'GET',
