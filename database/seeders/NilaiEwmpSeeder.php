    ...
    public function run(): void
    {
        $faker = \Faker\Factory::create();
            ...
            [
                ...
                'nama_tabel_rubrik'     =>  'r026_pengelola_jurnal_buletins',
                'ewmp'                  =>  1,
                'is_active'             =>  1,
            ],
            [
                ...
                'nama_tabel_rubrik'     =>  'r027_keanggotaan_senats',
                'ewmp'                  =>  1,
                'is_active'             =>  1,
            ],
            [
                ...
                'nama_tabel_rubrik'     =>  'r028_melaksanakan_pengembangan_diris',
                'ewmp'                  =>  1,
                'is_active'             =>  1,
            ],
            [
                ...
                'nama_tabel_rubrik'     =>  'r029_memperoleh_penghargaans',
                'ewmp'                  =>  0.5,
                'is_active'             =>  1,
            ],
            [
                ...
                'nama_tabel_rubrik'     =>  'r030_pengelola_kepks',
                'ewmp'                  =>  1.5,
                'is_active'             =>  1,
            ]
        ),
